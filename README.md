...
GitHub Actions runs the same Go quality script on Ubuntu and macOS, runs race tests on Ubuntu, uploads coverage, runs `golangci-lint`, and runs `govulncheck`. CodeQL analysis is handled by GitHub's default setup.
